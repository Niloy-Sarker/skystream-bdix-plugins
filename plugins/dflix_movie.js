...
async function getManifest() {
    return {
        id: "com.niloy.dflix.movie",
        name: "Dflix Movie",
        internalName: "dflixmovie",
        version: 2,
        description: "Dflix Movie Provider - Movies, Animation, Others",
        language: "bn",
        tvTypes: ["Movie", "Animation", "Others"],
        baseUrl: MAIN_URL,
        iconUrl: "",
        hasSearch: true
    };
...
function parseSeriesCards(html) {
    ...
    while ((match = cardRegex.exec(html)) !== null) {
        ...
        var urlMatch = /<a[^>]+href=['"](\/m\/view\/\d+)['"]/.exec(cardHtml);
...
async function loadStreams(url) {
    ...
    try {
        ...
        if (streams.length === 0 && url.includes("/m/")) {
